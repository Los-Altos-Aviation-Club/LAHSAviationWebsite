    ...
    <div className="min-h-screen pt-20 bg-surface relative overflow-hidden">
      ...
      <div className="relative z-10 bg-white border-b border-gray-100 py-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-br from-primary via-blue-500 to-sky-400">Our Mission</h1>
      ...
      <section className="py-20 px-6 lg:px-8 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto">
             <div className="text-center mb-12">
                 <h2 className="text-4xl md:text-5xl font-bold text-contrast mb-4">Meet the {currentYear}-{currentYear + 1} Team</h2>
                 <p className="text-secondary">The pilots, engineers, and dreamers behind the projects.</p>
             </div>
