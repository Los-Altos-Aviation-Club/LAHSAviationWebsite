        ...
        <footer className="bg-white py-12 px-6 border-t border-gray-100">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="text-xs text-secondary font-medium flex flex-col gap-2 md:gap-1 text-center md:text-left">
                    ...
                    <p className="opacity-70">Website created by Manxuan Zhang and Rodin Hooshiyar</p>
                    <Link to="/admin" className="mt-2 text-[10px] text-gray-300 hover:text-primary transition-colors uppercase tracking-widest font-bold">
