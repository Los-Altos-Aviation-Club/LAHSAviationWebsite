...
const EditableImage: React.FC<EditableImageProps> = ({ 
  ...
  const displaySrc = src || (isAdmin ? 'https://via.placeholder.com/400x300?text=Right+Click+To+Add+Image' : null);
  ...
  return (
    <>
      <div 
        ...
        className={`relative ${className} ${isAdmin ? 'cursor-context-menu group' : ''}`}
        title={isAdmin ? "Right-click to edit image" : undefined}
      >
